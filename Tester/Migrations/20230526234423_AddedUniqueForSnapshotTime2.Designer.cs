...
namespace TestEnv.Migrations
{
    ...
    [Migration("20230526234423_AddedUniqueForSnapshotTime2")]
    partial class AddedUniqueForSnapshotTime2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TestEnv.DBEntities.Price", b =>
                {
                    ...
                    b.HasIndex(new[] { "Epic", "Resolution", "SnapshotTime" }, "UN_Epic_Resolution_SnapshotTime")
                        .IsUnique();
